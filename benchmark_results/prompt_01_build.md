...
**Mode**: build
**Question**: Design a scalable API rate limiter using Redis. Provide a high-level architecture overview.

---

# Architectural Plan: Scalable API rate limiter using Redis

## Overview
This project involves creating a robust system for rate limiting API calls using Redis.
